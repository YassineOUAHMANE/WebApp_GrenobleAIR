...
export default {
  ...
  async mount(root) {
    ...
    root.innerHTML = `
      ...
      <div style="display: grid; grid-template-columns: 280px 1fr; gap: 1.5rem; grid-column: 1 / -1; min-height: calc(100vh - 200px);">
        ...
        <div class="card">
          ...
          <div id="bubble-chart" style="height: 100%; min-height: 400px; max-height: 570px; border: 1px solid rgba(79,124,255,0.2); border-radius: 8px; background: linear-gradient(135deg, rgba(79,124,255,0.05), rgba(41,193,140,0.05)); padding: 0; overflow: hidden;"></div>
        </div>
      </div>
